...
- Handle **XHTTP/WebSocket/GRPC/HttpUgrade** via **nginx**.
...
```
sudo su -c "$(command -v apt||echo dnf) -y install wget;bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -panel 1 -xuiver last -cdn off -secure no -country xx"
```
...
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -RandomTemplate yes
```

**Uninstall X-UI-PRO**:x:
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -Uninstall yes
```

**Enable Psiphon in WARP(Custom Country) <img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/cdnon.png" width="34">+<img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/psiphon.gif" width="15">**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -WarpCfonCountry US
```

**Enable Psiphon in WARP(Random Country)🌐🎲**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -WarpCfonCountry XX
```

**Tor Custom Country🧅🌍**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -TorCountry US
```

**Tor Random Country 🧅🎲**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -TorCountry XX
```
...
**Add LicenseKey to WARP<img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/cdnon.png" width="34">🔑**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -WarpCfonCountry XX -WarpLicKey xxxx-xxxx-xxxx
```

**Disable WarpPsiphon and WARP CleanKey❌**
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -CleanKeyCfon yes
```
...
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -ufw on
```
**Uninstall V2rayA ❌**
```
...
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -panel 1 -xuiver last -cdn on -secure yes -country xx"
```
#### Enable UFW Firewall
```
bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/master/x-ui-pro.sh) -ufw on
...
<img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/hr.png" width="100%">

### Server Configuration :wrench:🐧⚙️
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/Config_XUI_ADMIN_4.jpg)
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/grpc_config_format.jpg)
### Client Configuration 👨‍💻📱✏️
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/XUI_CONFIG_XRAY_CLIENT_EDIT2.png)
<img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/hr.png" width="100%">

## Enable WARP<img src="https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/cdnon.png" width="34"> TOR 🧅 (Fix Google&ChatGPT Forbidden/Hide VPS IP)
#### XUI > Xray Configs > Outbounds > Add Outbound ➕💾👇
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/warptor02.jpg)
#### Connect Config(Inbound) to WARP/WARP+/TOR/Psiphon/v2rayA (Outbound): :link:
#### XUI > Xray Configs > Routing Rules > Add Rule ➕💾👇
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/warptor3.jpg)
#### v2rayA Panel Settings (v2rayA suggested as Outbound and supports the subscription links):⚙️👇
![](https://raw.githubusercontent.com/Ntungwa/x-ui-pro/master/media/v2rayadminpanel2.jpg)
