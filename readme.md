...
```
sudo su -c "$(command -v apt||echo dnf) -y install wget;bash <(wget -qO- raw.githubusercontent.com/Ntungwa/x-ui-pro/refs/heads/master/x-ui-pro.sh) -panel 3 -xuiver last -cdn off -secure no -country xx"
```
